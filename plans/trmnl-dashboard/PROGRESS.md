...
**Status:** T06 implemented, awaiting review. Bus adapter resolves stop names to pole ids from
the stops dataset and fetches ckan2 departures per pole, returning `list[Departure] | Failure`,
never raising. One dead pole never hides a live one. Fixtures recorded live 2026-09-05
(Hynka poles 1767/1768, line 227). T00 still the only hand-verified task. 111 green.
...
| T06 | Bus adapter (ckan2 departures) | T02 | 🔍 | Implemented, awaiting review. resolve_stop_ids + fetch_departures + fetch_stops, all fixture-tested, no network. Real fixtures 2026-09-05 (Hynka poles 1767/1768, line 227). Per-pole isolation: one dead pole never hides a live one; Failure only if all poles fail. resolve returns list-per-name (type deviation, see commit). Config/caching to T08. 28 new tests, 111 green. |
