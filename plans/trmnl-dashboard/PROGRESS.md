...
| T03 | Pillow renderer → 1-bit BMP, golden-tested | T01, T02 | 🔍 | 800×480 mode-1, layout per mock minus top bar. Deviation: region titles plain ("POGODA" etc.), no "· Gdańsk"/"· Linia 227" — view-model carries no city/line (config, T08); owner may want them added. Bundled IBM Plex (OFL) + committed startup.bmp; goldens generated in Docker for FreeType determinism, regen one-liner in test. 53 tests green. |
