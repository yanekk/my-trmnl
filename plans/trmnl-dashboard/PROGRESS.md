...
**Status:** T05 reviewed clean. Weather adapter fetches Open-Meteo, returns
`WeatherData | Failure`, never raises. Review confirmed the tz contract end to end and hardened
its test. T00 still the only hand-verified task; T06 (bus adapter) is next to build.
**Last updated:** 2026-09-05
**Next `pir-work` will:** implement T06 (bus adapter, ckan2 departures).
